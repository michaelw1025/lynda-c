...
namespace PropChallenge
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // --More than 3 Savings withdrawals should result in a 2.00 charge
            ...
            // --Try to overdraw Checking - should result in extra charge of 35
            checking.Withdraw(3000.0m);

            // --Check the balances
            // --Expected output should be -385 and 988.63 at this point
            Console.WriteLine($"Checking balance is {checking.Balance:C2}");
            Console.WriteLine($"Savings balance is {saving.Balance:C2}");
        }
    }
